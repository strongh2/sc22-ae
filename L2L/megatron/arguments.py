...
def parse_args(extra_args_provider=None, defaults={},
    ...
    parser = _add_strongh_args(parser)
...
def _add_strongh_args(parser):
    group = parser.add_argument_group(title="stronghold")

    group.add_argument('--enable-l2l', action='store_true', default=None,
                       help='if enabling l2l offloading strategy')
    group.add_argument('--enbale-strongh', action='store_true', default=None,
                       help='if enabling stronghold strategy')
