...
class CPU_Float16OptimizerWithFloat16Params(MegatronOptimizer):
    """Float16 optimizer for fp16 and bf16 data types.
    Arguments:
        optimizer: base optimizer such as Adam or SGD
        clip_grad: clip gradeints with this global L2 norm. Note
    ...
    def __init__(
        ...
        super(CPU_Float16OptimizerWithFloat16Params, self).__init__(
            optimizer,
            clip_grad,
            log_num_zeros_in_grad,
            params_have_main_grad,
    ...
    def _unscale_main_grads_and_check_for_nan(self, start_index=0, end_index=-1):
        ...
        # ), " CPU_Float16OptimizerWithFloat16Params, _unscale_main_grads_and_check_for_nan,  self.grad_scaler.inv_scale, not only includes one elements"
    ...
    def step(self, start_index=0, end_index=-1):
        # print(
        #     f"---. CPU_Float16OptimizerWithFloat16Params optimizer: start_index={start_index}, end_index={end_index}"
        # )
        timers = get_timers()
...
class CPU_FP32Optimizer(MegatronOptimizer):
    def __init__(
        self,
        optimizer,
        clip_grad,
        ...
        super(CPU_FP32Optimizer, self).__init__(
            optimizer,
            clip_grad,
            log_num_zeros_in_grad,
            params_have_main_grad,
