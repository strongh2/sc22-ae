...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(
        ...
        if self.add_encoder:
            # _PT = GLParallelTransformer if args.enable_gl else ParallelTransformer
            _PT = ParallelTransformer
            self.encoder = _PT(
                self.init_method,
                output_layer_init_method,
        ...
        if self.add_decoder:
            ...
            # _PT = GLParallelTransformer if args.enable_gl else ParallelTransformer
            _PT = ParallelTransformer if args.enable_gl else ParallelTransformer
            self.decoder = _PT(
                self.init_method,
                output_layer_init_method,
