...
class MegatronGradScaler(ABC):
    ...
    def __init__(self, initial_scale, cpu=False):
...
class GL_CPU_DynamicGradScaler(MegatronGradScaler):
    ...
    def __init__(self, initial_scale, min_scale,
        ...
        """"Grad scaler with dynamic scale that gets adjusted
        during training."""
        super(GL_CPU_DynamicGradScaler, self).__init__(initial_scale, cpu=True)
